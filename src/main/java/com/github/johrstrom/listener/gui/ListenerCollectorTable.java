...
public class ListenerCollectorTable extends AbstractCollectorTable<ListenerCollectorConfig>
    ...
    private static final JComboBox<String> listenToComboBox;
    private static final JComboBox<String> measuringComboBox;
    private static final ConfigCollectorTable stealFrom = new ConfigCollectorTable();

    private static final int LISTEN_TO_INDEX = ConfigCollectorTable.BASE_COLUMN_SIZE;
    private static final int MEASURING_INDEX = LISTEN_TO_INDEX + 1;
