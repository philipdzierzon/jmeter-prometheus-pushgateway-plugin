 ...
 * objects.  Along with being a TestElement so that it can be serialized (for the .jmx file) it also handles all the
 * logic of parsing strings into double arrays.
 * <p>
 * There are also static utility functions to actually instantiate a Collector of a given type from a configuration.
 * <p>
 * <p>
 * buckets are comma seperated list of decimals. An example: 100,200,300,400.3 quantiles are comma seperated pair of
 * decimals seperated by |. The first decimal being the quantile and the second being the error rating. An example:
        ...
        QuantileDefinition(String[] definition) throws NumberFormatException {
            if (definition.length != 2) {
                throw new IllegalArgumentException(
                        String.format("Quantiles need exactly 2 parameters. %d given.", definition.length));
            }
        ...
        public static QuantileDefinition[] parseQuantilesFromString(String fullQuantileString) {
            ...
            for (String quantile : quantileDefStrings) {
                try {
                    ...
                    log.warn(
                            "couldn't parse {} because of error {}:{}. It wont be included in quantiles for the metric",
