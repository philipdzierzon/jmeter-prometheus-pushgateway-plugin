...
public class PrometheusMetricsConfigGui<C> extends AbstractConfigGui {
    ...
    private final ConfigCollectorTable table = new ConfigCollectorTable();

    private final Logger log = LoggerFactory.getLogger(PrometheusMetricsConfigGui.class);

    public PrometheusMetricsConfigGui() {
        super();
        log.debug("making a new config gui: {}", this);
        init();
    }
